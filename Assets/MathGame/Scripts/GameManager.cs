...
public class GameManager : MonoBehaviour 
{
	...
	public Image timeImage; //the slider in the top of the game screen
	...
	{
		timeImage.fillAmount = timeTotalGame / 10;
		...
		while (true) 
		{
			...
			Debug.Log(((float)Mathf.Sqrt(level)));

			timeImage.fillAmount -= timer / 10;
	...
	private void GameOver()
	{
		...
		FindObjectOfType<AdsManager> ().ShowAdsGameOver ();
	...
	public void OnClicked(Text text)
	{
		...
		{
			timeImage.fillAmount -= (float)((timeTotalGame) / 5) / 10; 
